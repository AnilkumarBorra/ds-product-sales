...
from BankSystemDB import BankSystem
from ProductSales import ProductSales
...
def main():
    while True:
        ...
        print("3. Run Task 3 for SQL Product Sales")
        print("4. Run Task 4 for Customer and Department Sales Analysis")
        print("5. Exit")
